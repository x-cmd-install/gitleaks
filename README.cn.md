...
[![x-cmd/install — gitleaks Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/gitleaks.svg?lang=zh)](https://x-cmd.com/install/gitleaks)
...
合计: **21,659** 行代码（覆盖前 5 种语言、共 **271** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 17,830 | 1,709 | 2,040 | 214 |
| Toml | 3,617 | 39 | 338 | 51 |
| Json | 86 | 0 | 0 | 4 |
| Sh | 52 | 24 | 4 | 1 |
| Makefile | 27 | 0 | 10 | 1 |
...
- **上游仓库**: <https://github.com/gitleaks/gitleaks>
...
- **Star**: 29,487 · **Fork**: 2,245 · **开放 issue**: 986 · **贡献者**: 216

## 累计统计

- **发布数**: 190 · **已合并 PR**: 697 · **开放 PR**: 215 · **已关闭 issue**: 717 · **开放 issue**: 269 · **提交数**: 1291

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-27 | 0 | 0 | 13 | 0 | 6 | 0 |
| last60d | 2026-07-28 | 0 | 0 | 34 | 0 | 10 | 0 |
| 90d | 2026-06-28 | 0 | 2 | 57 | 2 | 16 | 2 |
| last180d | 2026-03-30 | 0 | 8 | 119 | 6 | 41 | 11 |
| 360d | 2025-10-01 | 4 | 18 | 144 | 19 | 63 | 26 |
| last720d | 2024-10-06 | 26 | 173 | 173 | 104 | 134 | 229 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/gitleaks.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T04:45:01Z._
